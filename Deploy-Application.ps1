...
Try {
	...
	[string]$appName = 'GUI'
	[string]$appVersion = '760 P9 Lite'
	[string]$appArch = 'x86'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '08/27/2021'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		$exitCode = Execute-Process -Path "$dirFiles\Setup\NwSapSetup.exe" -Parameters "/package:`"SAPGUI_760_LITE`" /silent"
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		$exitCode = Execute-Process -Path "$dirFiles\Setup\NwSapSetup.exe" -Parameters "/uninstall /all /silent"
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUjV2KilA0WCG5RWlVUg8DeZFL
# LU2gghHXMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# MRYEFBn6PKYv8I//Wf29Dl6CQa4/tvkLMA0GCSqGSIb3DQEBAQUABIIBgG72hmAP
# nP3nDTLf+AQ24FY9T/LS5yTZM6jedyc7uNPqCiQjQluvGiL7BLmMRzhZfTGC/82c
# S2a9jMGklKIxHOLTn7RQUbSaXJGOkSwRakAe5bTw5nN43Rc7jufpw/bix2Zf8qmx
# Yu4Giz2p1+q/8/2R0Fdiaamd6xfU6BtqHuvP0CD9DcwquHVYN9wWjFJEGZ74fb7P
# sTa7yDHKtV8JRDEhRVVxPPIe8xXdz7ovtx3p0qYUPAtwaDK/9Ivk91qOeZmJ9fH9
# /bc2P0rhLPMSKEhwYzN8HsZgEiNl8UpJUT8ZKfojq0RHILsbkBpc3tPs16d92ote
# a1iXBnS8wJ6josYLAGfY6NVvAtAsGPIiiR/yXHQ7OJegmq3AaP9VbCZ3Zg8xyoIq
# lzPfR8AMUJispiz2Bl2VDDAlztskybchhJQyj3tiGmrInLwvUllxaIDsW1+PEwvm
# izg9xMHJdFrHvKNtW3eas+Men5j8poFWUbv3oqnJlN+eLoREUpA0fZs9cQ==
